...
featured: false
category: technology
pubDatetime: 2025-09-18T19:02+08:00
title: 集成 LightGallery 灯箱
slug: integrating-lightgallery
ogImage: https://cos.lhasa.icu/ArticlePictures/integrating-lightgallery/lightgallerylogo.png_81
tags:
  - LightGallery
  - Update
description: 集成 LightGallery
---
...
有时候想想也是，看似隐式优于显式想法，实际上和过去接手的屎山一样，可读性极差，别人一眼看过去，完全不知道：`"false" "false"`代表啥。说到底，屎山并不是一行行代码堆出来的，而是“偷懒”习惯养成的。
